...
import ExpenseAction from "./ExpenseAction/ExpenseAction"
import { getStatusBadge } from "@/dummyData/expenseRecords"
import TablePagination from "@/components/shared/CommonTable/TablePagination"

const ExpenseCardsContainer = ({
  data = [],
  actionKey = "id",
  itemsPerPage = 10,
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    <span className="text-dark-gray text-xs font-semibold uppercase tracking-wider">Description</span>
                    <span className="text-dark-accent">{row.description}</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-dark-gray">{row.vendor}</span>
                  </div>
                  <div className="flex items-center justify-between">
