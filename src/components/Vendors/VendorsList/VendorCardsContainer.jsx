...
import { getStatusBadge } from "@/dummyData/vendorRecords"
import TablePagination from "@/components/shared/CommonTable/TablePagination"

const VendorCardsContainer = ({
  data = [],
  actionKey = "id",
  itemsPerPage = 10,
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    <span className="text-dark-gray text-xs font-semibold uppercase tracking-wider">Company</span>
                    <span className="text-dark-gray">{row.company}</span>
                  </div>
                  <div className="flex items-center justify-between">
...
export default VendorCardsContainer
