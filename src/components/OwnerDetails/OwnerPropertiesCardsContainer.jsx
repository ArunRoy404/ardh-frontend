...
const OwnerPropertiesCardsContainer = ({
  data = [],
  actionKey = "id",
  itemsPerPage = 10,
        ...
        {paginatedData.length > 0 ? (
          paginatedData.map((row, rowIdx) => {
            ...
            return (
              <div
                key={rowId}
                className="bg-card border border-border rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow relative"
              >
                {/* Header row: Flat name + Status */}
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-dark-accent">{row.building}</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-dark-accent font-semibold">{row.rent}</span>
                  </div>
                </div>
...
export default OwnerPropertiesCardsContainer
