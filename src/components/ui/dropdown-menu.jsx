    ...
    <MenuPrimitive.Portal>
      <MenuPrimitive.Positioner
        ...
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-100 outline-none data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:overflow-hidden data-closed:fade-out-0 data-closed:zoom-out-95",
            "w-36 bg-popover border border-border rounded-xl shadow-lg p-1",
            className
          )}
          {...props} />
      </MenuPrimitive.Positioner>
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        ...
        "px-3 py-2 text-xs rounded-lg flex items-center gap-2 transition-colors text-dark-accent! hover:bg-muted focus:bg-muted cursor-pointer",
        className
      )}
      {...props} />
  );
