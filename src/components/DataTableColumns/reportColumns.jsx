import ReportIncomeAction from "@/components/Reports/ReportsList/ReportAction/ReportIncomeAction"
import ReportExpenseAction from "@/components/Reports/ReportsList/ReportAction/ReportExpenseAction"
...
// ─── Income Column Definitions ───────────────────────────────────────────────

export const reportIncomeColumns = [
  {
    accessorKey: "type",
    header: "Type",
    cell: ({ getValue }) => (
  ...
  },
  {
    id: "actions",
    header: "Action",
    cell: ({ row }) => <ReportIncomeAction record={row.original} />,
  },
]

// ─── Expense Column Definitions ──────────────────────────────────────────────

export const reportExpenseColumns = [
  {
  ...
  },
  {
    id: "actions",
    header: "Action",
    cell: ({ row }) => <ReportExpenseAction record={row.original} />,
  },
]
